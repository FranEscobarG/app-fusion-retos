              ...
              ElevatedButton(
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all(
                      const Color.fromARGB(255, 58, 106, 183)),
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text("221198"),
            Text("Francisco de Jesus Escobar Gutierrez "),
            SizedBox(height: 20),
            Row(
              ...
              children: [
                IconButton(
                  icon: Icon(Icons.phone,
                      color: const Color.fromARGB(255, 202, 66, 66)),
                  iconSize: 30,
                  onPressed: () async {
                    final call = Uri.parse('tel:+529612545998');
                ...
                IconButton(
                  icon: Icon(Icons.message,
                      color: const Color.fromARGB(255, 194, 81, 81)),
                  iconSize: 30,
                  onPressed: () async {
